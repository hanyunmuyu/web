...
class ClubRepository
{
    ...
    public function getClubList($categoryIds = null,$limit=16)
    {
    ...
    public function getClubListRandom($categoryId,$limit=6)
    {
        return ClubModel::whereRaw("FIND_IN_SET({$categoryId},category_ids)")
            ->orderBy(DB::raw("RAND()"))
            ->limit($limit)
            ->get();
    }
