    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100 h-25 h-25"
                            ...
                            <ul class="list-inline">
                                @for($i=0;$i<10;$i++)
                                    <li class="list-inline-item col-5 col-sm-4 col-md-2 text-center">
                                        <div>
                                            <img class="img-thumbnail rounded" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1528551893864&di=d37656d1cd518477fd40c0b40454e03f&imgtype=0&src=http%3A%2F%2Fwww.ccutu.com%2Fupload%2Fimage%2F20170926%2F6364204577626002132488200.jpg">
                                        </div>
                                        <div>
                                            编程爱好者
                                        </div>
        ...
        <div class="col-10">
            <div class="row">
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="list-comprehensive" role="tabpanel" aria-labelledby="list-comprehensive-list">
                        <div class="row">
                            <ul class="list-inline">
                                @for($i=0;$i<10;$i++)
                                    <li class="list-inline-item col-5 col-sm-4 col-md-2 text-center">
                    ...
                    <div class="tab-pane fade" id="list-economic" role="tabpanel" aria-labelledby="list-economic-list">
                        <div class="row">
                            <ul class="list-inline">
                                @for($i=0;$i<10;$i++)
                                    <li class="list-inline-item col-5 col-sm-4 col-md-2 text-center">
